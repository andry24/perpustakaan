...
<form action="cari_act.php" method="get">
	<div class="input-group col-md-5 col-md-offset-7">
		...
		<input type="text" class="form-control" placeholder="Cari buku.." aria-describedby="basic-addon1" name="cari">	
	</div>
</form>
<br/>
			...
			<div class="modal-body">
				<form action="tambah_buku.php" method="post">
					...
					<div class="form-group">
						...
						<input name="tanggal_terbit" type="text" class="form-control" placeholder="Tanggal terbit .." id="tgl">
					</div>
					<div class="form-group">

...
<form action="cari_pengembalian.php" method="get">
	<div class="input-group col-md-5 col-md-offset-7">
		...
		<input type="text" class="form-control" placeholder="Cari Data Pengembalian .." aria-describedby="basic-addon1" name="cari">	
	</div>
</form>
<br/>
<table class="table table-hover">
	...
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				<a href="detail_pengembalian.php?no=<?php echo $b['kode_pengembalian']; ?>" class="btn btn-info">Detail</a></td>
				<td><a href="edit_pengembalian.php?no=<?php echo $b['kode_pengembalian']; ?>" class="btn btn-warning">Edit</a></td>
